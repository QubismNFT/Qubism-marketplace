...
import { CollectionCreated, ItemListed, ItemDelisted, Swapped } from '../generated/QubismMarket/QubismMarket'
import { QubismNFT as QubismNFTTemplate } from '../generated/templates'
...
export function handleCollectionCreated(event: CollectionCreated): void {
  ...
  QubismNFTTemplate.create(event.params.collection_address)
  entity.save()
}
