...
export class QubismAuction__auctionBidsResult {
  value0: Address;
  value1: BigInt;
...
export class QubismAuction__auctionsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class QubismAuction__getCurrentBidsResult {
  value0: BigInt;
  value1: Address;
...
export class QubismAuction extends ethereum.SmartContract {
  static bind(address: Address): QubismAuction {
    return new QubismAuction("QubismAuction", address);
  }
  ...
  auctionBids(
    param0: BigInt,
    param1: BigInt
  ): QubismAuction__auctionBidsResult {
    let result = super.call(
      "auctionBids",
    ...
    return new QubismAuction__auctionBidsResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_auctionBids(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<QubismAuction__auctionBidsResult> {
    let result = super.tryCall(
      "auctionBids",
      "auctionBids(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new QubismAuction__auctionBidsResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  auctions(param0: BigInt): QubismAuction__auctionsResult {
    let result = super.call(
      "auctions",
    ...
    return new QubismAuction__auctionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctions(
    param0: BigInt
  ): ethereum.CallResult<QubismAuction__auctionsResult> {
    let result = super.tryCall(
      "auctions",
      "auctions(uint256):(uint256,address,uint256,uint256,uint256,uint256,address,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new QubismAuction__auctionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getCurrentBids(_auctionId: BigInt): QubismAuction__getCurrentBidsResult {
    let result = super.call(
      "getCurrentBids",
    ...
    return new QubismAuction__getCurrentBidsResult(
      result[0].toBigInt(),
      result[1].toAddress()
    );
  }
  ...
  try_getCurrentBids(
    _auctionId: BigInt
  ): ethereum.CallResult<QubismAuction__getCurrentBidsResult> {
    let result = super.tryCall(
      "getCurrentBids",
      "getCurrentBids(uint256):(uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(_auctionId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new QubismAuction__getCurrentBidsResult(
        value[0].toBigInt(),
        value[1].toAddress()
      )
    );
