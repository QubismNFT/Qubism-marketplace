...
export class QubismMarket__pairsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class QubismMarket extends ethereum.SmartContract {
  static bind(address: Address): QubismMarket {
    return new QubismMarket("QubismMarket", address);
  }
  ...
  pairs(param0: BigInt): QubismMarket__pairsResult {
    let result = super.call(
      "pairs",
    ...
    return new QubismMarket__pairsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_pairs(param0: BigInt): ethereum.CallResult<QubismMarket__pairsResult> {
    let result = super.tryCall(
      "pairs",
      "pairs(uint256):(uint256,address,uint256,address,address,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
