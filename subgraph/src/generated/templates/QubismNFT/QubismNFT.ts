...
export class QubismNFT__ItemsResult {
  value0: BigInt;
  value1: Address;
  value2: string;
  value3: BigInt;
...
export class QubismNFT extends ethereum.SmartContract {
  static bind(address: Address): QubismNFT {
    return new QubismNFT("QubismNFT", address);
  }
  ...
  Items(param0: BigInt): QubismNFT__ItemsResult {
    let result = super.call(
      "Items",
    ...
    return new QubismNFT__ItemsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toString(),
      result[3].toBigInt()
  ...
  try_Items(param0: BigInt): ethereum.CallResult<QubismNFT__ItemsResult> {
    let result = super.tryCall(
      "Items",
      "Items(uint256):(uint256,address,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
