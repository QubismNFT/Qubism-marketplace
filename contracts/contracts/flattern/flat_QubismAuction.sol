...
/** 
 *  SourceUnit: d:\GitWork\GrahamWorking\QubismNFT\contracts\contracts\QubismAuction.sol
*/
...
contract QubismAuction is Ownable, ERC721Holder {
    ...
    {   
        ...
        IQubismNFT nft = IQubismNFT(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            IQubismNFT(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = IQubismNFT(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = IQubismNFT(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            IQubismNFT(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
